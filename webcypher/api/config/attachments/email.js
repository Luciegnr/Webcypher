...
<body style="background: #f9f9f9;">
    <div style="background-color: #f9f9f9;">
        ...
        <div class="container"
            style="max-width: 640px; margin: 0 auto; box-shadow: 0px 1px 5px rgba(0, 0, 0, 0.1); overflow: hidden;">
            <div
                style="max-width: 640px; margin: 0 auto; box-shadow: 0px 1px 5px rgba(0, 0, 0, 0.1); border-radius: 4px; overflow: hidden; text-align: center; vertical-align: top; direction: ltr; font-size: 0px; padding: 57px;">
                <a href="etechtalents.com"><img src="cid:header" alt="Snow" style="width: 100%;" /></a>
            </div>
        </div>
                                            ...
                                            <td style="word-break: break-word; font-size: 0px; padding: 0px 0px 20px;"
                                                ...
                                                <div
                                                    ...
                                                    <h2
                                                        ...
                                                        Bienvenue chez Webcypher, </h2>
                                                    <p>Merci de nous avoir rejoins ! Afin de confirmer la création de
                                                        votre compte chez nous, merci de vérifier votre mail en suivant
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="border: none; border-radius: 3px; color: white; cursor: auto; padding: 15px 19px;"
                                                                align="center" valign="middle" bgcolor="#4A1B5F">
                                                                <a href="http://localhost:3000/connexion/${code}" style="
                                                                          text-decoration: none;
                                                                          line-height: 100%;
                                                                          background: #4A1B5F;
                                                                          color: white;
